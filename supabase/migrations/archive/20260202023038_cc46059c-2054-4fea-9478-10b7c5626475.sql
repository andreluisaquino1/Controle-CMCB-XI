-- Update get_dashboard_summary to include gastos_recursos
...
DECLARE
  ...
  weekly_gastos_recursos numeric := 0;
...
BEGIN
  ...
  -- Gastos de Recursos (same as pix_direto_uecx for now but named explicitly)
  weekly_gastos_recursos := weekly_direct_pix;
  ...
  result := jsonb_build_object(
    ...
    'weeklyGastosRecursos', weekly_gastos_recursos,
