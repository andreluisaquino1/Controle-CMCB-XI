...
import { useEntitiesWithAccounts, useCreateAccount, useUpdateAccount, useDeactivateAccount, useActivateAccount } from "@/shared/hooks/use-accounts";
import { useMerchants } from "@/features/merchants/hooks/use-merchants";
import { useRecursosTransactions } from "@/features/transactions/hooks/use-entity-transactions";
import { getTodayString, formatDateString } from "@/shared/lib/date-utils";
...
import { AccountDialog } from "@/shared/components/dialogs/AccountDialog";
  ...
  const handleEntradaSubmit = async () => {
    ...
    try {
      ...
      await transactionService.createLedgerTransaction({
        ...
        created_at: `${entrada.date}T12:00:00`,
        metadata: {
