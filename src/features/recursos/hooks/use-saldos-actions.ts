...
import { useCreateMerchant, useUpdateMerchant, useDeactivateMerchant, useActivateMerchant } from "@/features/merchants/hooks/use-merchants";
import { getTodayString } from "@/shared/lib/date-utils";
import { formatCurrencyBRL } from "@/shared/lib/currency";
import { aporteSaldoSchema, consumoSaldoSchema } from "@/shared/lib/schemas";
...
export function useSaldosActions(
    ...
    return {
        ...
        handlers: {
            ...
            handleAporteSubmit,
            handleGastoSubmit: async () => true, // Handled internally by ConsumoSaldoDialog
            resetAporte,
            resetGasto
        },
