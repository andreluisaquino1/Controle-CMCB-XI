            ...
            >
                ...
                <div className="space-y-4 pt-4">
                    <div className="space-y-2">
                        <Label htmlFor="consumo-merchant">Estabelecimento *</Label>
                        <Select value={state.merchant} onValueChange={setters.setMerchant}>
                            <SelectTrigger id="consumo-merchant">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="consumo-obs">Observação</Label>
                        <Input id="consumo-obs" value={state.obs} onChange={(e) => setters.setObs(e.target.value)} placeholder="Opcional" />
                    </div>
