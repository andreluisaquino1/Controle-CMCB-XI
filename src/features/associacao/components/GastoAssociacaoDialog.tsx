...
import { ACCOUNT_NAMES, ACCOUNT_NAME_TO_LEDGER_KEY } from "@/shared/lib/constants";
            ...
            >
                ...
                <div className="space-y-4 pt-4">
                    <div className="space-y-2">
                        <Label htmlFor="gasto-assoc-meio">Meio de Pagamento *</Label>
                        <Select value={state.meio} onValueChange={setters.setMeio}>
                            <SelectTrigger id="gasto-assoc-meio">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="gasto-assoc-obs">Observação</Label>
                        <Input
                            id="gasto-assoc-obs"
                            value={state.obs}
